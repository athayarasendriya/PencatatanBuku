...
@section('container')
    ...
    <div class="jumbotron">
        <div class="card">
            ...
            <div class="card-body">
                <p class="card-text">Web Pencatatan Informasi Buku | Athaya Rasendriya - XI RPL 2</p>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ url('/books' . '/' . $item->id) }}" method="post">
                                        ...
                                        <button class="btn btn-danger badge rounded-pill"
                                            style="width: 80px; height: 25px;" type="submit" onclick="return confirm(&quot;Yakin Dihapus?&quot;)">HAPUS</button>
                                    </form>
                                    {{-- <a href="{{ url() }}" class="btn btn-danger badge rounded-pill"
                                        style="width: 80px; height: 25px;">HAPUS</a> --}}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
